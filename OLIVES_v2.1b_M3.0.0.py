#!/usr/bin/env python
print("OLIVES_v2.1b_M3.0.0.py is written by Kasper Busk Pedersen, 16th of July 2024.")
...
def match_tertiary_network(checked_pairs_dists_energies, checked_pairs, a_ndx_to_res_name, a_ndx_to_bead_name):
    ...
    special_residues = {"GLN", "ASN", "ARG", "LYS", "ASP", "GLU"}
...
def main():
    ...
    for p,pdb_CG in enumerate(pdbs_CG):
        ...
        matched_tertiary_pairs, matched_tertiary_pairs_dists_energies = match_tertiary_network(checked_tertiary_pairs_dists_energies, checked_tertiary_pairs, a_ndx_to_res_name, a_ndx_to_bead_name)
