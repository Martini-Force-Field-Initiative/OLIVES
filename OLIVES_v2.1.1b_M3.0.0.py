#!/usr/bin/env python
print("OLIVES_v2.1.1b_M3.0.0.py is written by Kasper Busk Pedersen, 29th of July 2024.")
...
special_residues = {"GLN", "ASN", "ARG", "LYS", "ASP", "GLU"} #HIS not included since it is mapped with higher resolution, allowing multiple HBs per side chain in the first matching round 
