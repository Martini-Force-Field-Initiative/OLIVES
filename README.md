...
can be viewed by running:
    ...
    python3 OLIVES_v1.3_M3.0.0.py -h
...
and then apply the OLIVES model via:
    ...
    python3 OLIVES_v1.3_M3.0.0.py -c "protein_CG.pdb" -i "molecule_0.itp"
...
OLIVES also comes with a basic multistate functionality. A two-state model can be created by providing two conformations of the same protein (must have matching topologies):
    ...
    python3 OLIVES_v1.3_M3.0.0.py -c "protein_CG_conformation_1.pdb,protein_CG_conformation_2.pdb" -i molecule_0.itp --unique_pair_scaling "0.5,0.75"
